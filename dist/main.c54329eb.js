...
new Vue({
  ...
  methods: {
    fetchAnimals: function fetchAnimals(e) {
      var alert = document.querySelector("#alert");
      // quick validation
      if (this.$refs.form.validate(e)) {
        e.preventDefault();
        // fetching animals
        (0, _fetchJsonp2.default)("http://api.petfinder.com/pet.find?format=json&key=6c05ad76afb30803f826bda51957c226&animal=" + this.select + "&location=" + this.zip + "&callback=callback", {
...
},{"fetch-jsonp":143}],11:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.c54329eb.map